            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div variants={item}>
                ...
                <div className="mt-3 flex gap-2">
                  {/* We pass specific handlers if VaultCard was pure, 
                       but for now internal buttons exist. 
                       I'll add overlay trigger logic if needed, 
                       or just keep them as separate actions. */}
                </div>
              </motion.div>
              <motion.div variants={item}>
                <VaultCard
